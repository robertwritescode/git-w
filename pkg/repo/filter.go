...
func Filter(cfg *config.WorkspaceConfig, cfgPath string, names []string) ([]Repo, error) {
	if len(names) == 0 {
...
func ForContext(cfg *config.WorkspaceConfig, cfgPath string) ([]Repo, error) {
...
func ForGroup(cfg *config.WorkspaceConfig, cfgPath string, groupName string) ([]Repo, error) {
...
func resolveTargets(cfg *config.WorkspaceConfig, cfgPath string, names []string) ([]Repo, error) {
...
func resolveTarget(cfg *config.WorkspaceConfig, cfgPath, name string, byRepo map[string]Repo) ([]Repo, error) {
...
func forGroup(cfg *config.WorkspaceConfig, cfgPath string, groupName string, g config.GroupConfig) ([]Repo, error) {
